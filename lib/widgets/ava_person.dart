...
class AvatarImage1 extends StatelessWidget {
  const AvatarImage1(this.name, {this.width = 100, this.height = 100, this.bgColor, this.borderWidth = 0, this.borderColor, this.trBackground = false, this.isSVG = true, this.radius = 50});
  final String name;
  final double width;
  final double height;
